...
Girder worker is a complex system that requires several moving parts. It relies heavily on Celery and so this documentation will link out to Celery often.
